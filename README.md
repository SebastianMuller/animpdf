...
If using Python directly you one can also modify the final line of the script, and pass the filename and optional parameters to the ```make_slides``` command.
